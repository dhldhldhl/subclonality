...
seg.df <- read.delim('liquidCNA-main/Example/Segment_table.txt')
cn.df <- read.delim('liquidCNA-main/Example/RawCN_table.txt')
load('liquidCNA-main/Example/Parameters.RData')

###############################################
#### Preprocessing segment CN distribution #### 
###############################################
...
cutOffVec <- seq(0.025,0.3,by=0.005) #cut-off values for pre-filtering
